...
using Renderer.Types.Buffers;
using Renderer.Types.Buffers.Index;
using Renderer.Types.Buffers.Vertex;
using Renderer.Types.Shaders;
using Renderer.Types.Textures;
using Renderer.Types.Views;
using Windowing;
...
{
    public static RuntimeLogger Logger { get; } = new("Renderer");
