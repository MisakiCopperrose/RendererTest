...
public static unsafe class Bgfx
{
    ...
    public static void VertexConvert(VertexLayout destinationLayout, IntPtr destinationData, VertexLayout sourceLayout,
        IntPtr sourceData, int count = 1)
    {
    ...
    {
        fixed (byte* ptr = data)
            NativeMethods.bgfx_dbg_text_image((ushort)x, (ushort)y, (ushort)width, (ushort)height, new IntPtr(ptr),
                (ushort)pitch);
    }
    ...
    public static void SetViewClear(ushort id, ClearTargets targets, uint colorRgba, float depth = 1.0f,
        byte stencil = 0)
    {
