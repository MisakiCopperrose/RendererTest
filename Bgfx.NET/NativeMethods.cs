...
#pragma warning disable IDE1006 // Naming Styles
    ...
    public static extern bool bgfx_alloc_transient_buffers(out TransientVertexBuffer tvb, ref VertexLayout.Data decl,
        ushort numVertices, out TransientIndexBuffer tib, ushort numIndices);
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void bgfx_set_frame_buffer_name(ushort handle, [MarshalAs(UnmanagedType.LPStr)] string name,
        int len);
    ...
    public static extern ushort bgfx_create_frame_buffer_from_nwh(IntPtr nwh, ushort width, ushort height,
        TextureFormat format, TextureFormat depthFormat);
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void bgfx_set_vertex_buffer_name(ushort handle, [MarshalAs(UnmanagedType.LPStr)] string name,
        int len);
    ...
    public static extern ushort bgfx_create_texture_3d(ushort width, ushort _height, ushort _depth,
        [MarshalAs(UnmanagedType.U1)] bool hasMips, TextureFormat format, TextureFlags flags, MemoryBlock.DataPtr* mem);
    ...
    public static extern void
        bgfx_set_shader_name(ushort handle, [MarshalAs(UnmanagedType.LPStr)] string name, int len);
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void bgfx_set_index_buffer_name(ushort handle, [MarshalAs(UnmanagedType.LPStr)] string name,
        int len);
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr bgfx_override_internal_texture(ushort handle, ushort width, ushort height, byte numMips,
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int bgfx_submit_occlusion_query(ushort id, ushort programHandle, ushort queryHandle, int depth,
        [MarshalAs(UnmanagedType.U1)] bool preserveState);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int bgfx_submit_indirect(ushort id, ushort programHandle, ushort indirectHandle, ushort start,
        ushort num, int depth, [MarshalAs(UnmanagedType.U1)] bool preserveState);
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern ushort bgfx_weld_vertices(ushort* output, ref VertexLayout.Data decl, IntPtr data, ushort num,
        float epsilon);
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int bgfx_vsnprintf(sbyte* str, IntPtr count, [MarshalAs(UnmanagedType.LPStr)] string format,
        IntPtr argList);
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void bgfx_encoder_set_instance_data_from_dynamic_vertex_buffer(IntPtr encoder, ushort handle,
        int startVertex, int count);
    ...
    public static extern int bgfx_encoder_submit_indirect(IntPtr encoder, ushort id, ushort programHandle,
        ushort indirectHandle, ushort start, ushort num, int depth, [MarshalAs(UnmanagedType.U1)] bool preserveState);
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void bgfx_encoder_set_compute_dynamic_index_buffer(IntPtr encoder, byte stage, ushort handle,
        ComputeBufferAccess access);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void bgfx_encoder_set_compute_dynamic_vertex_buffer(IntPtr encoder, byte stage, ushort handle,
        ComputeBufferAccess access);
    ...
    public static extern int bgfx_encoder_dispatch_indirect(IntPtr encoder, ushort id, ushort program,
        ushort indirectHandle, ushort start, ushort num);
